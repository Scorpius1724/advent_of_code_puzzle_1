CALIBRATION_STRING = """hcpjssql4kjhbcqzkvr2fivebpllzqbkhg
...
calibration_list = CALIBRATION_STRING.split("\n")
...
for item in calibration_list:
    ...
    calibration_dict[item] = integer_list


value_list = []

for item in calibration_dict.values():
    value_list.append(int(item[0] + item[-1]))

required_value = sum(value_list)
